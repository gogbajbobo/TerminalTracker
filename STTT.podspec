Pod::Spec.new do |s|
  ...
  s.source_files = 'TerminalTracker/*.lproj/Localizable.strings', 'TerminalTracker/Classes/STTT*.{h,m}', 'TerminalTracker/Data Model/STTT*.{h,m}'
  s.resources = 'TerminalTracker/*.lproj/STTT*.storyboard', 'TerminalTracker/Data Model/*.{xcdatamodel,xcdatamodeld}'
